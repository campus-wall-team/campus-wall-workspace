...
| [板块分类 + AI 多模态需求](60-feature-requirements/00-需求总览.md) | 9+1 篇专题需求：5 板块(推荐/二手/兼职/推广/组队) + AI 视觉标注/知识入库/智能推荐 + [09 本地大模型部署与降级](60-feature-requirements/09-本地大模型部署与降级.md)(本地优先 + 云端 failover) |
